  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        walnut: { DEFAULT: "oklch(0.30 0.065 30)", dark: "oklch(0.23 0.055 30)", light: "oklch(0.42 0.06 32)" },
        ivory: "oklch(0.978 0.006 80)",
        beige: "oklch(0.95 0.018 80)",
        gold: { DEFAULT: "oklch(0.70 0.12 65)", dark: "oklch(0.62 0.11 60)", light: "oklch(0.82 0.09 70)" },
      ...
      boxShadow: {
        ...
        gold: "0 4px 20px oklch(0.70 0.12 65 / 0.3)",
        luxury: "0 8px 40px oklch(0.19 0.045 30 / 0.12)",
      },
      keyframes: {
